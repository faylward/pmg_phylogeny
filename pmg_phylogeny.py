...
args_parser.add_argument('-p', '--parse_only', type=bool, default=False, const=True, nargs='?', help='Implies that the all_hmm.out file is already present and should be parsed. Skips HMM search, gene prediction, etc)')
...
if not (args_parser.parse_only):
	...
	print "Only parsing all_hmm.out file\n"
